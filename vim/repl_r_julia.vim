...
augroup REPL_R
    ...
    au FileType r,julia nnoremap <buffer> \d            <cmd>call Send_cmd('dbDisconnect(con_mkt, shutdown = TRUE); dbDisconnect(con_ec, shutdown = TRUE); dbDisconnect(con_am, shutdown = TRUE); duckdb_shutdown(duckdb::duckdb())')<CR>
