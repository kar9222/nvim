...
-- use 'ray-x/navigator.lua'  -- TODO
-- use 'sindrets/diffview.nvim'  -- TODO See issues #39 for inline-diff
...
-- use 'karb94/neoscroll.nvim'  -- Slightly laggy, probably due to terminal's rendering performance.  Might revisit if a better terminal is found.
