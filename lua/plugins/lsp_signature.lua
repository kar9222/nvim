-- TODO Setup is working but it's the 'correct/minimal' way?

local M = {}
-- local LspSignature = require('lsp_signature')

-- TODO require'lsp_signature'.on_attach(cfg, bufnr) -- no need to specify bufnr if you don't use toggle_key
-- LspSignature.setup({
...
function M.on_attach(client, bufnr)
    ...
    toggle_key = [[<m-a>]] -- toggle signature on and off in insert mode,  e.g. toggle_key = '<M-x>'
